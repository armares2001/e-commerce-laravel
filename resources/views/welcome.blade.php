<x-layout>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-md-6 my-3">
                                ...
                                <form action="{{route('search')}}" method='GET' class='d-flex' >
                                    <input type='search' name='searched'class='form-control me-2' placeholder="{{__('ui.cerca')}}">
                            ...
                            <div class="col-12 col-md-3 d-flex align-items-center justify-content-center my-2">
                                    ...
                                    <button type="button" class="btn-sezione btn-warning d-flex " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        ...
                                        <p class="mt-2">{{__('ui.Ordina_per')}}</p>
    ...
    <div class="container-fluid my-5 py-5 overflow-hidden">
        <div class="row ">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">{{__('ui.Ordina')}}</h5>
